...
if (cookie_policy_url === undefined) {
    var cookie_policy_url = 'http://193.200.193.11/pages/cookie.php';
}
if (nibirumail_advice_text === undefined) {
    var nibirumail_advice_text = "Bibliotech utilizza i cookies per offrirti un'esperienza di navigazione migliore. Usando il nostro servizio accetti l'impiego di cookie in accordo con la nostra cookie policy. <a target=\"_blank\" href=\"" + cookie_policy_url + "\">Scoprine di pi&ugrave;</a>. <a class=\"nibirumail_agreement\" href=\"javascript:;\">Ho capito.</a>";
}
